...
public class reservasi extends javax.swing.JFrame {
    ...
    public String tglPergi, tglPulang,nama,paket,kelas,status,cari;
    public reservasi() {
        initComponents();
        data = new String[2];
        con = new koneksiApp().getConnect();
        String []judul={"ID","Nama Pemesan","Paket","Kelas","Tgl Pergi","tgl Pulang","Status"};
...
private void tampilkan() {
        ...
        try {
            sql ="SELECT rsv.id_reservasi, rsv.nama,pkt.nama_paket, rsv.kelas, rsv.tanggal_pergi, rsv.tanggal_pulang, rsv.status "
                    + "FROM reservasi AS rsv INNER JOIN paket AS pkt ON rsv.id_paket=pkt.id_paket";
...
private void reset(){
        ...
        fieldTglPergi.setDate(null);
        fieldTglPulang.setDate(null);
}
    /**
    ...
    private void initComponents() {
        ...
        fieldTglPergi = new com.toedter.calendar.JDateChooser();
        fieldTglPulang = new com.toedter.calendar.JDateChooser();
        ...
        jLabel5.setText("Tanggal Pergi");

        fieldTglPergi.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                fieldTglPergiPropertyChange(evt);
            }
        });

        fieldTglPulang.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                fieldTglPulangPropertyChange(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(fieldTglPulang, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(fieldTglPergi, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                .addGap(965, 965, 965))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {fieldIdReservasi, fieldKelas, fieldNama, fieldPaket, fieldStatus, fieldTglPergi, fieldTglPulang});
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fieldTglPergi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel5))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fieldTglPulang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel6))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel7)
    ...
    private void tabelReservasiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelReservasiMouseClicked
        ...
        Date datePergi = null,datePulang = null;  
            try {
                datePergi = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 4).toString());
                datePulang = new SimpleDateFormat("yyyy-MM-dd").parse((String)model.getValueAt(i, 5).toString());
            } catch (ParseException ex) {
                Logger.getLogger(reservasi.class.getName()).log(Level.SEVERE, null, ex);
            }
            fieldTglPergi.setDate(datePergi);
            fieldTglPulang.setDate(datePulang);
                
        fieldStatus.setText(model.getValueAt(i, 6).toString());
        } 
    }//GEN-LAST:event_tabelReservasiMouseClicked

    private void fieldTglPergiPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_fieldTglPergiPropertyChange
       if(fieldTglPergi.getDate()!=null){
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
            tglPergi = format.format(fieldTglPergi.getDate());
        }
    }//GEN-LAST:event_fieldTglPergiPropertyChange

    private void fieldTglPulangPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_fieldTglPulangPropertyChange
       if(fieldTglPulang.getDate()!=null){
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
            tglPulang = format.format(fieldTglPulang.getDate());
        }
    }//GEN-LAST:event_fieldTglPulangPropertyChange
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        sql = "UPDATE reservasi SET nama='"+nama+"', kelas='"+kelas+"', tanggal_pergi='"+
                tglPergi+"', tanggal_pulang='"+tglPulang+"', status='"+status+"' WHERE id_reservasi='"+idEdit+"'";
    ...
    private com.toedter.calendar.JDateChooser fieldTglPergi;
    private com.toedter.calendar.JDateChooser fieldTglPulang;
